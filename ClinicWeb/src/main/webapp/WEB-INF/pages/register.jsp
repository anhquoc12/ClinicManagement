                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            ...
                            <f:form action="${action}" modelAttribute="user" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4 form-floating mb-3 mt-3">
                                    <f:input path="email" type="email" id="form3Example3cg" class="form-control form-control-lg" />
                                    <label class="form-label" for="form3Example3cg">Email</label>
                                </div>

                                <div class="form-outline mb-4 form-floating mb-3 mt-3">
                                    <f:input path="phone" type="text" id="form3Example3cg" class="form-control form-control-lg" />
                                    <label class="form-label" for="form3Example3cg">Số Điện Thoại</label>
                                </div>

                                <div class="col-md-9 pe-5 mb-2">

                                    <f:input path="file" class="form-control form-control-lg" id="formFileLg" type="file" />
